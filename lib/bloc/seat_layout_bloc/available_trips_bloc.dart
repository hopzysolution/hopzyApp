...
// class AvailableTripsBloc extends Bloc<AvailableTripsEvent, AvailableTripsState> {

//   Layout? seatLayout;

//   AvailableTripsBloc() : super(AvailableTripsInitial()) {
//     on<AvailableTripsFetchEvent>((event, emit) async {
...
//           emit(AvailableTripsLoaded(seatLayout: seatLayout));
//         } else {
//           final message = data["status"]?["message"] ?? "Failed to load trips";
//           emit(AvailableTripsFailure(error: message));
//         }
//       } catch (e) {
//         print("Error in getAvailableTrips: $e");
//         emit(AvailableTripsFailure(error: "Something went wrong. Please try again."));
//       }
//     });
//   }
// }