...
//     'Mysore', 'Jaipur', 'Mumbai', 'Hampi', 'Goa'
//   ];
...
//     try {
//       const String geminiApiKey = 'AIzaSyCZRLpjjzWNGpIOi6gJHJ92M6_bBHZ0z6I';
...
//         setState(() {
//           _tripData = TripPlanData.fromJson(tripPlanJson);
//           _showForm = false;
//         });
//       } else {
...
//               borderRadius: BorderRadius.circular(8),
//               border: const Border(
//                 left: BorderSide(color: Color(0xFF0047FF), width: 4),
//               ),
//             ),
//             child: Column(
//               crossAxisAlignment: CrossAxisAlignment.start,
...
//     final borderColor = isOdd ? const Color(0xFF0047FF) : const Color(0xFFFF8055);
...
//         borderRadius: BorderRadius.circular(12),
//         border: Border.all(color: const Color(0xFFE2E8F0)),
//         // borderLeft: BorderSide(color: borderColor, width: 5),
//         boxShadow: [
//           BoxShadow(
...
//         if (mounted) {
//           _iconControllers[i].repeat(period: const Duration(seconds: 10));
//         }
//       });
//     }
//   }
...
//                     return Opacity(
//                       opacity: _iconAnimations[index].value,
