...
class _EnhancedBusInfoBottomSheetState
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => BookingBloc(widget.tripData!, paymentVerified),
  ...
  Widget _buildBusRouteTab() {
    return Column(
      children: [
        _buildRouteItem(
          widget.tripData!.src.toString(),
          "${DateFormat('hh:mm a').format(DateTime.parse(widget.tripData!.deptime.toString()))}",
          true,
        ),
        _buildRouteConnector(),
        _buildRouteItem(
          widget.tripData!.dst.toString(),
          "${DateFormat('hh:mm a').format(DateTime.parse(widget.tripData!.arrtime.toString()))}",
          false,
        ),
        _buildRouteConnector(),
        ...
        children: [
          ...
          PassengerCard(
            ...
            selectedPassengerss: (List<Passenger> finalPassengerList) {
              ...
              BlocProvider.of<BookingBloc>(context).getProfile();
            },
          ),
          SizedBox(height: 16),
          GstFormWidget(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          Text(review, style: TextStyle(fontSize: 13, color: Colors.grey[700])),
        ],
      ),
    );
  }
