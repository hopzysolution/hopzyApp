...
class ApiConst {
  ...
  static String baseUrl2 =
      "https://prodapi.hopzy.in/"; //"https://stagingapi.hopzy.in/";//"
  ...
  static const String accessToken =
      "MTE1YzI2YzEwOWMxMDdjOTNjMTA2YzEwMmM4OWMxMDFjOTNjMjZjNTBjMjRjMjZjOTZjMTAzYzEwNGMxMTRjMTEzYzEwN2MxMDBjMjZjMzZjMjZjMTA0Yzg5YzEwN2MxMDdjMTExYzEwM2MxMDZjOTJjMjZjNTBjMjZjNjRjMTAzYzc1YzEwM2M0MmMxMDRjMTA4YzQ5YzI2YzExN2M3MA==";
  ...
  static const String getAllAvailableTrips =
      "GetAllAvailableTripsOnADay/apiagent";

  static const String getAvailableTrips =
      "api/public/trips"; //"GetAvailableTrips/apiagent";
  static const String getAllAvailableTripsOnADay =
      "GetAllAvailableTripsOnADay/apiagent";

  static const String getSeatLayout =
      "api/public/layout"; //"GetSeatLayout/apiagent";
  ...
  static const String confirmCancelBooking =
      "api/public/confirmCancelBooking"; //"ConfirmCancel/apiagent";
  ...
  static const String paymentVerification =
      "api/public/payu/success"; //"api/public/verify-payment";
  ...
  static const String getUserBookings =
      "api/private/user/bookings?limit=500&page=1"; //&phone=%2B{phoneNumber}";
  static const String registerUser = "api/auth/register";

  static const String confirmTentative =
      "api/public/confirmBookingFromTentative";
  //ticket details
  static const String ticketDetails = "GetTicketAllInfo/apiagent";
  static const String getPendingBooking =
      "api/public/pending-bookings/pnr/{thispnr}";

  static const String bookingTicketDetails = "api/public/bookings/{ticketId}";
  static const String walletBalance = "api/private/wallet";
  static const String getTransactions =
      "api/private/wallet/transactions?limit=500&page=1";
