...
import 'package:ridebooking/utils/app_colors.dart'; // Adjust path if needed
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        inputFormatters: [
          FilteringTextInputFormatter.allow(RegExp(r"[a-zA-Z\s]")), // allow letters + space
        ...
        decoration: InputDecoration(
          hintText: lable!=null?lable:'Full Name',
          hintStyle: TextStyle(
